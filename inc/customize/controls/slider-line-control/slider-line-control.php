<?php
	...
	class internet_service_provider_pro_Slider_Custom_Control extends WP_Customize_Control {
		/**
	...
	function internet_service_provider_pro_slider_line_script() {
	...
	add_action( 'customize_controls_enqueue_scripts', 'internet_service_provider_pro_slider_line_script' );
