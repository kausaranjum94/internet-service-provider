...
class internet_service_provider_pro_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="total-icon-list clearfix">
                    ...
                    <?php
                    $internet_service_provider_pro_font_awesome_icon_array = internet_service_provider_pro_font_awesome_icon_array();
                    foreach ($internet_service_provider_pro_font_awesome_icon_array as $internet_service_provider_pro_font_awesome_icon) {
                            $icon_class = $this->value() == $internet_service_provider_pro_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($internet_service_provider_pro_font_awesome_icon).'"></i>
                                <span class="vw-social-class">'.esc_attr($internet_service_provider_pro_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function internet_service_provider_pro_customizer_script() {
...
add_action( 'customize_controls_enqueue_scripts', 'internet_service_provider_pro_customizer_script' );

if(!function_exists('internet_service_provider_pro_font_awesome_icon_array')){
    function internet_service_provider_pro_font_awesome_icon_array(){
