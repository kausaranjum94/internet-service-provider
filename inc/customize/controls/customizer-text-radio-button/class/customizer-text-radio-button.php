 ...
 */
 class internet_service_provider_pro_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
 ...
 */
if ( ! function_exists( 'internet_service_provider_pro_text_sanitization' ) ) {
	function internet_service_provider_pro_text_sanitization( $input ) {
