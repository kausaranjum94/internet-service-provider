<?php
    ...
    $wp_customize->add_setting( 'internet_service_provider_pro_newsletter_widget_input_bgcolor', array(
      'default' => '',
      'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'internet_service_provider_pro_newsletter_widget_input_bgcolor', array(
      'label' => __('Input Background Color', 'internet-service-provider-pro'),
      'section' => 'internet_service_provider_pro_newsletter',
      'settings' => 'internet_service_provider_pro_newsletter_widget_input_bgcolor',
    )));
  
   $wp_customize->add_setting( 'internet_service_provider_pro_newsletter_button_ct_pallete',
  array(
    'default' => '',
    'transport' => 'postMessage',
    'sanitize_callback' => 'internet_service_provider_pro_text_sanitization'
  ));
  $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'internet_service_provider_pro_newsletter_button_ct_pallete',
      array(
      'label' => __('Section Button Typography ','internet-service-provider-pro'),
      'section' => 'internet_service_provider_pro_newsletter'
  )));

  $wp_customize->add_setting( 'internet_service_provider_pro_newsletter_button_color', array(
      'default' => '',
      'sanitize_callback' => 'sanitize_hex_color'
  ));
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'internet_service_provider_pro_newsletter_button_color', array(
      'label' => __('Color', 'internet-service-provider-pro'),
      'section' => 'internet_service_provider_pro_newsletter',
      'settings' => 'internet_service_provider_pro_newsletter_button_color',
  )));
  $wp_customize->add_setting('internet_service_provider_pro_newsletter_button_font_family',array(
      'default' => '',
      'capability' => 'edit_theme_options',
      'sanitize_callback' => 'sanitize_text_field'
  ));
  $wp_customize->add_control(
      'internet_service_provider_pro_newsletter_button_font_family', array(
      'section'  => 'internet_service_provider_pro_newsletter',
      'label'    => __('Font Family','internet-service-provider-pro'),
      'type'     => 'select',
      'choices'  => $font_array,
  ...
  $wp_customize->add_setting('internet_service_provider_pro_newsletter_button_font_size',array(
      'default' => '',
      'sanitize_callback' => 'sanitize_text_field'
  ));
  $wp_customize->add_control('internet_service_provider_pro_newsletter_button_font_size',array(
      'label' => __('Font Size','internet-service-provider-pro'),
      
      'section' => 'internet_service_provider_pro_newsletter',
      'setting' => 'internet_service_provider_pro_newsletter_button_font_size',
      'type'    => 'number'
  ));

  $wp_customize->add_setting( 'internet_service_provider_pro_newsletter_button_bgcolor', array(
      'default' => '',
      'sanitize_callback' => 'sanitize_hex_color'
  ));
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'internet_service_provider_pro_newsletter_button_bgcolor', array(
      'label' => __('Background Color', 'internet-service-provider-pro'),
      'section' => 'internet_service_provider_pro_newsletter',
      'settings' => 'internet_service_provider_pro_newsletter_button_bgcolor',
  )));

  $wp_customize->add_setting( 'internet_service_provider_pro_newsletter_button_hover_bgcolor', array(
      'default' => '',
      'sanitize_callback' => 'sanitize_hex_color'
  ));
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'internet_service_provider_pro_newsletter_button_hover_bgcolor', array(
      'label' => __('Hover Background Color', 'internet-service-provider-pro'),
      'section' => 'internet_service_provider_pro_newsletter',
      'settings' => 'internet_service_provider_pro_newsletter_button_hover_bgcolor',
  )));

  $wp_customize->add_setting( 'internet_service_provider_pro_newsletter_button_text_color_hover', array(
      'default' => '',
      'sanitize_callback' => 'sanitize_hex_color'
  ));
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'internet_service_provider_pro_newsletter_button_text_color_hover', array(
      'label' => __('Hover Text Color', 'internet-service-provider-pro'),
      'section' => 'internet_service_provider_pro_newsletter',
      'settings' => 'internet_service_provider_pro_newsletter_button_text_color_hover',
  )));
  ...
  $wp_customize->add_control('internet_service_provider_pro_section_footer_bg_attachment', array(
    ...
    $wp_customize->add_setting( 'internet_service_provider_pro_footer_menu_item_hover_color', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'internet_service_provider_pro_footer_menu_item_hover_color', array(
        'label' => __('Hover Color', 'internet-service-provider-pro'),
        'section' => 'internet_service_provider_pro_footer_menu_section',
        'settings' => 'internet_service_provider_pro_footer_menu_item_hover_color',
    )));
    ...
    $wp_customize->add_setting('internet_service_provider_pro_footer_copyright_text',array(
    	'default' => '',
    	'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('internet_service_provider_pro_footer_copyright_text',array(
    	'label' => __('Add Text','internet-service-provider-pro'),
    	'section' => 'internet_service_provider_pro_footer_copyright_section',
    	'setting' => 'internet_service_provider_pro_footer_copyright_text',
    	'type' => 'text'
    ));
