...
class internet_service_provider_pro_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'internet_service_provider_pro_About_Widget',
			__('VW About Us', 'internet-service-provider-pro'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'internet-service-provider-pro' ), )
		);
	}
	...
	?>
		<p>
        <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:','internet-service-provider-pro'); ?></label>
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>">
    	</p>
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','internet-service-provider-pro'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','internet-service-provider-pro'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','internet-service-provider-pro'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','internet-service-provider-pro'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','internet-service-provider-pro'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','internet-service-provider-pro'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function internet_service_provider_pro_about_custom_load_widget() {
	register_widget( 'internet_service_provider_pro_About_Widget' );
}
add_action( 'widgets_init', 'internet_service_provider_pro_about_custom_load_widget' );
