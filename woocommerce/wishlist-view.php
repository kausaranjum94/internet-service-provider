...
<table
	...
	<tbody class="wishlist-items-wrapper row">
	<?php
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				?>
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>" class="">
					<?php if ( $show_cb ) : ?>
					...
					<?php if ( $show_remove_product ) : ?>
						<td class="product-remove remove-whishlist">
							<div>
					...
					<?php if( $product->is_type( 'simple' ) ){ woocommerce_template_loop_rating( $product->post, $product ); } ?>
					</div>
					</td>
					<?php if ( $show_price || $show_price_variations ) : ?>
		...
		<tr>
			<td colspan="<?php echo esc_attr( $column_count ); ?>" class="wishlist-empty">
				<div class="empty-cart-page" id="empty-cart-page">
				  <i class="<?php echo esc_html(get_theme_mod('internet_service_provider_pro_empty_cart_page_icon')); ?>"></i>
				  <h2 id="empty-cart-heading"><?php echo esc_html(get_theme_mod('internet_service_provider_pro_empty_cart_page_heading')); ?></h2>
				  <p><?php echo esc_html(get_theme_mod('internet_service_provider_pro_empty_cart_page_description')); ?></p>
				  <a href="<?php echo esc_url(get_theme_mod('internet_service_provider_pro_empty_cart_page_btn_link')); ?>">
				    <?php echo esc_html(get_theme_mod('internet_service_provider_pro_empty_cart_page_btn_text')); ?>
				  </a>
				</div>
